    ...
    <div id="branchesTable" class="" style="margin: 0 auto;">
        <table id="tbl1" class="table-borderless  table-responsive" style="">
            <tr class="">
                ...
                <td class="" style="background-color: #e7ec84">
                    <a href="/placement/2">
                    <span>
                    شعبه گوهردشت
                    </span>
            ...
            <tr class="">
                <td class="" style="background-color:#e6ecba">
                    <a href="/placement/3">
                        <span>شعبه درختی
                        </span>
                    </a>
                </td>
                <td class="" style="background-color:rgb(227,236,151)">
                    <a href="/placement/4"><span>شعبه شهریار</span></a>
                </td>
            </tr>
            </tbody>
        </table>
