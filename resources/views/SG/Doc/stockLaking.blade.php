            ...
            <div id="tbldiv" class="">
                ...
                <div>
                    <input type="button" id="btnSubmit"
                           ...
                           onclick="funcSubmit()">
                    {{--<input class="btn" style="float: right;width: 100px" type="button"--}}
                    {{--onclick="enterBarcode($('#barcode0').val(),'barcode0')" tabindex="-1" value="barcode">--}}
                    {{--<input id="btnAmm3Index" class="btn" style="float: right;width: 100px" type="button"--}}
                    {{--onclick="amm3Index()"--}}
                    {{--tabindex="-1" value="edit">--}}
                </div>
